...
<div class="main-content">
    <form action="<?=BASE_PATH?>update_cate&id=<?=$get_one_cate['CategoryID']?>" method="post">
                    ...
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="card">
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="<?=$get_one_cate['CategoryName']?>"  id="title" onkeyup="ChangeToSlug();" class="form-control">
                                    <label>Slug</label>
                                    <input type="text" name="slug" value="<?=$get_one_cate['CategorySlug']?>" id="slug" class="form-control">
                                    <label>Mô tả</label>
                                    <input type="text" name="desc" value="<?=$get_one_cate['Description']?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Trạng thái danh mục</label>
                                    <div class="selectgroup w-100">
                                        <?php if ($get_one_cate['Status'] == 1) :?>
                                        ...
                                        <?php elseif($get_one_cate['Status'] == 2) : ?>
                                            <label class="selectgroup-item">
