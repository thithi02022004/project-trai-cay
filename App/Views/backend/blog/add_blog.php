...
<div class="main-content">
    <form action="<?=BASE_PATH?>add_blog" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row" style="justify-content: space-around;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="title" onkeyup="ChangeToSlug();" class="form-control" style="width:450px">
                                    </div>
                                    <div class="form-group">
                                        <label>Slug</label>
                                        <input type="text" name="slug" style="width: 400px" id="slug" class="form-control" style="width:450px">
                                    </div>
                                </div>
                               <div class="row" style="justify-content: space-around;">
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="detail" name="content" class="form-control" rows="10"></textarea>
                                </div>
                                <div class="form-group">
