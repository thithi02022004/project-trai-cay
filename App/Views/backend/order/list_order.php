                                                            ...
                                                            <?php if ($od['ShippingStatus'] != 5 && $od['ShippingStatus'] != 6) : ?>
                                                                ...
                                                                <td>
                                                                    <?php if ($od['ShippingStatus'] == 1 ) : ?>
                                                                        <a href="<?=BASE_PATH?>ShippingStatus&id=<?=$od['OrderID']?>" class="btn btn-warning" >Chờ duyệt</a>
                                                                    <?php elseif($od['ShippingStatus'] == 2 ) :?>
                                                                        <a href="<?=BASE_PATH?>ShippingStatus&id=<?=$od['OrderID']?>" class="btn btn-info" >Đã nhận đơn</a>
                                                                    <?php elseif($od['ShippingStatus'] == 3 ) :?>
                                                                        <a href="<?=BASE_PATH?>ShippingStatus&id=<?=$od['OrderID']?>" class="btn btn-info" >Đang xử lý</a>
                                                                    <?php elseif($od['ShippingStatus'] == 4 ) :?>
                                                                        <a href="<?=BASE_PATH?>ShippingStatus&id=<?=$od['OrderID']?>" class="btn btn-info" >Đang giao</a>
                                                                    <?php elseif($od['ShippingStatus'] == 5 ) :?>
                                                                        <a href="<?=BASE_PATH?>ShippingStatus&id=<?=$od['OrderID']?>" class="btn btn-success" >Giao thành công</a>
