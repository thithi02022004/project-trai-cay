<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Thương hiệu</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?=BASE_PATH?>list_brand">Quản lý thương hiệu</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Sản phẩm</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?=BASE_PATH?>list_product">Quản lý sản phẩm</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Đơn hàng</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?=BASE_PATH?>list_order">Quản lý đơn hàng</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Banner quảng cáo</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?=BASE_PATH?>list_banner">Quản lý banner</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Config trang web</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?=BASE_PATH?>list_config">Quản lý Config</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Bài viết</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="<?=BASE_PATH?>list_blog">Quản lý bài viết</a></li>
                </ul>
            </li>
