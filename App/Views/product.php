            ...
            <div class="row">
                ...
                <div id="main-content" class="main-content col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="product-category grid-style">
                        ...
                        <div style="height: 60px;" id="top-functions-area" class="top-functions-area">
                          
                                <div class="row">
                                    <a style="margin-left:25px;padding: 20px" href="<?=BASE_PATH?>shop&high_to_low">Giá cao đến thấp </a>
                                    <a style="margin-left:25px;padding: 20px" href="<?=BASE_PATH?>shop&low_to_high">Giá Thấp đến cao </a>
                                    <a style="margin-left:25px;padding: 20px" href="<?=BASE_PATH?>shop&discount">Giảm giá </a>
                                    <a style="margin-left:25px;padding: 20px" href="<?=BASE_PATH?>shop&view">Lượt xem </a>
                                    <a style="margin-left:25px;padding: 20px" href="<?=BASE_PATH?>shop&sold">Lượt mua </a>
                                </div>
                        ...
                        <div class="row">
                            <ul class="products-list">
                                <?php if (isset($_GET['high_to_low'])) : ?>
                                    <?php foreach ($high_to_low as $key => $pro) : ?>
                                    ...
                                    <?php endforeach ?>
                                <?php elseif(isset($_GET['low_to_high'])) : ?>
                                    <?php foreach ($low_to_high as $key => $pro) : ?>
                                        <li class="product-item col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                            <div class="contain-product layout-default">
                                                <div class="product-thumb">
                                                    <a href="<?=BASE_PATH?>product_detail/<?=$pro['Slug']?>" class="link-to-product">
                                    ...
                                    <?php endforeach ?>
                                <?php elseif(isset($_GET['discount'])) : ?>
                                    <?php foreach ($shop_discount as $key => $pro) : ?>
                                        <li class="product-item col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                            <div class="contain-product layout-default">
                                                <div class="product-thumb">
                                ...
                                <?php elseif(isset($_GET['view'])) : ?>
                                    <?php foreach ($shop_view as $key => $pro) : ?>
                                        <li class="product-item col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                            <div class="contain-product layout-default">
                                                <div class="product-thumb">
                                                    <a href="<?=BASE_PATH?>product_detail/<?=$pro['Slug']?>" class="link-to-product">
                                    ...
                                    <?php endforeach ?>
                                <?php elseif(isset($_GET['sold'])) : ?>
                                    <?php foreach ($shop_sold as $key => $pro) : ?>
                                        <li class="product-item col-lg-2 col-md-3 col-sm-4 col-xs-6">
                                            <div class="contain-product layout-default">
                                                <div class="product-thumb">
                                                    <a href="<?=BASE_PATH?>product_detail/<?=$pro['Slug']?>" class="link-to-product">
