                    ...
                    <div class="slide-contain slider-opt03__layout01">
                        <div class="media">
                            <div class="child-elememt">
                                <a href="<?=BASE_PATH?><?=$banner['URL']?>" class="link-to">
                                    <img src="<?=BASE_PATH?>public/frontend/assets/images/products/<?=$banner['ImageURL']?>" width="604" height="580" alt="">
                                </a>
                            </div>
                        </div>
                        <div class="text-content">
                            <!-- <i class="first-line">Pomegranate</i> -->
                            <h3 class="second-line"><?=$banner['Title']?></h3>
                            <p class="third-line"><?=$banner['Content']?></p>
                            <p class="buttons">
                                <a href="<?=BASE_PATH?><?=$banner['URL']?>" class="btn btn-bold">Xem Ngay</a>
                        ...
                        <div class="banner-contain">
                            <div class="media">
                                <a href="#" class="bn-link">
                                    <figure><img src="public/frontend/assets/images/home-03/bn_special_org.jpg" width="616" height="483" alt=""></figure>
                                </a>
                            </div>
                            <div class="text-content">
    ...
    <div class="product-tab z-index-20 sm-margin-top-193px xs-margin-top-30px">
        <div class="container">
            <div class="biolife-title-box">
                ...
                <h3 class="main-title">Dành cho bạn</h3>
            </div>
            <div class="biolife-tab biolife-tab-contain sm-margin-top-34px">
                <div class="tab-head tab-head__icon-top-layout icon-top-layout">
                    <ul class="tabs md-margin-bottom-35-im xs-margin-bottom-40-im">
                        <li class="tab-element active">
                            <a href="#tab01_1st" class="tab-link"><span class="biolife-icon icon-lemon"></span>Bán chạy</a>
                        </li>
                        <li class="tab-element">
                            <a href="#tab01_2nd" class="tab-link"><span class="biolife-icon icon-grape2"></span>Giảm giá</a>
                        </li>
                        <li class="tab-element">
                            <a href="#tab01_3rd" class="tab-link"><span class="biolife-icon icon-blueberry"></span>Xem nhiều</a>
                        </li>
                        <li class="tab-element">
                            <a href="#tab01_4th" class="tab-link"><span class="biolife-icon icon-orange"></span>Sản phẩm mới</a>
                        </li>
                    </ul>
                </div>
                <div class="tab-content">
                    <div id="tab01_1st" class="tab-contain active">
                        <ul class="products-list biolife-carousel nav-center-02 nav-none-on-mobile eq-height-contain" data-slick='{"rows":2 ,"arrows":true,"dots":false,"infinite":true,"speed":400,"slidesMargin":10,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3, "slidesMargin":25 }},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":15}}]}'>
                            <?php foreach ($quantitysold as $key => $pro): ?>
                            <li class="product-item">
                                <div class="contain-product layout-default">
                                    <div class="product-thumb">
                                        <a href="<?=BASE_PATH?>product_detail/<?=$pro['Slug']?>" class="link-to-product">
                                            <img src="public/frontend/assets/images/products/<?=$pro['Image']?>" alt="Vegetables" width="270" height="270" class="product-thumnail">
                                        </a>
                                        <a class="lookup btn_call_quickview" href="#"><i class="biolife-icon icon-search"></i></a>
                                    </div>
                                    <div class="info">
                                        <b class="categories">Đã Bán: <?=$pro['QuantitySold']?></b>
                                        ...
                                        <div class="slide-down-box">
                                            ...
                                            <div class="buttons">
                                                ...
                                                <a href="<?=BASE_PATH?>add_cart&id=<?=$pro['ProductID']?>" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ hàng</a>
                    ...
                    <div id="tab01_2nd" class="tab-contain ">
                        ...
                        <?php foreach ($discount as $key => $pro): ?>
                            <li class="product-item">
                                <div class="contain-product layout-default">
                                    <div class="product-thumb">
                        ...
                        <?php foreach ($view as $key => $pro): ?>
                            <li class="product-item">
                                <div class="contain-product layout-default">
                                    ...
                                    <div class="info">
                                        <b class="categories"> <?=$pro['Views']?> Lượt xem</b>
                                        <h4 class="product-title"><a href="#" class="pr-name"><?=$pro['ProductName']?></a></h4>
                                        <div class="price ">
                                            <ins><span class="price-amount"><span class="currencySymbol">£</span><?=number_format($pro['Price'])?></span></ins>
                                            <del><span class="price-amount"><span class="currencySymbol">£</span><?=number_format($pro['Price'])?></span></del>
            ...
            <div class="banner-contain">
                <div class="media background-biolife-banner__promotion">
                    <div class="img-moving position-1">
                        <img src="public/frontend/assets/images/home-03/img-moving-pst-1.png" width="149" height="139" alt="img msv">
                    </div>
                    <div class="img-moving position-2">
                        <img src="public/frontend/assets/images/home-03/img-moving-pst-2.png" width="185" height="265" alt="img msv">
                    </div>
                    <div class="img-moving position-3">
                        <img src="public/frontend/assets/images/home-03/img-moving-pst-3-cut.png" width="384" height="151" alt="img msv">
                    </div>
                    <div class="img-moving position-4">
                        <img src="public/frontend/assets/images/home-03/img-moving-pst-4.png" width="198" height="269" alt="img msv">
                    </div>
                </div>
                <div class="text-content">
                ...
                <div class="col-lg-4 col-md-5 col-sm-6">
                    <div class="advance-product-box">
                        ...
                        <ul class="products biolife-carousel nav-top-right nav-none-on-mobile" data-slick='{"arrows":true, "dots":false, "infinite":false, "speed":400, "slidesMargin":30, "slidesToShow":1}'>
                            <?php foreach ($discount as $key => $dc) :?>
                                    <li class="product-item">
                                        <div class="contain-product deal-layout contain-product__deal-layout">
                                            <div class="product-thumb">
                                                <a href="<?=BASE_PATH?>product_detail/<?=$dc['Slug']?>" class="link-to-product">
                                                    <img src="<?=BASE_PATH?>public/frontend/assets/images/products/<?=$dc['Image']?>" alt="dd" width="330" height="330" class="product-thumnail">
                                                </a>
                                                <div class="labels">
                                                    <span class="sale-label"><?= $dc['Discount']?>%</span>
                                                </div>
                                            </div>
                                            <div class="info">
                                                <!-- <div class="biolife-countdown" data-datetime="2020/02/18 00:00:00"></div> -->
                                                <!-- <b class="categories">Fresh Fruit</b> -->
                                                <h4 class="product-title"><a href="#" class="pr-name"><?= $dc['ProductName']?></a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">£</span><?= number_format($dc['Price'])?></span></ins>
                                                    <!-- <del><span class="price-amount"><span class="currencySymbol">£</span>95.00</span></del> -->
                                                </div>
                                                <div class="slide-down-box">
                                                    <p class="message"><?= substr($dc['Description'], 0, 100) ?>...</p>
                                                    <div class="buttons">
                                                        <a href="#" class="btn wishlist-btn"><i class="fa fa-heart" aria-hidden="true"></i></a>
                                                        <a href="<?=BASE_PATH?>add_cart&id=<?=$dc['ProductID']?>" class="btn add-to-cart-btn">Thêm Vào Giỏ Hàng</a>
                                                        <a href="#" class="btn compare-btn"><i class="fa fa-random" aria-hidden="true"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="col-lg-8 col-md-7 col-sm-6">
                    <div class="advance-product-box">
                        ...
                        <ul class="products biolife-carousel eq-height-contain nav-center-03 nav-none-on-mobile row-space-29px" data-slick='{"rows":2,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":2,"responsive":[{"breakpoint":1200,"settings":{ "rows":2, "slidesToShow": 2}},{"breakpoint":992, "settings":{ "rows":2, "slidesToShow": 1}},{"breakpoint":768, "settings":{ "rows":2, "slidesToShow": 2}},{"breakpoint":500, "settings":{ "rows":2, "slidesToShow": 1}}]}'>
                            <?php foreach ($quantitysold as $key => $sold) : ?>
                                <li class="product-item">
                                        <div class="contain-product right-info-layout contain-product__right-info-layout">
                                            <div class="product-thumb">
                                                <a href="<?=BASE_PATH?>product_detail/<?=$sold['Slug']?>" class="link-to-product">
                                                    <img src="public/frontend/assets/images/products/<?= $sold['Image'] ?>" alt="dd" width="270" height="270" class="product-thumnail">
                                                </a>
                                            </div>
                                            <div class="info">
                                                <!-- <b class="categories">Vegetables</b> -->
                                                <h4 class="product-title"><a href="#" class="pr-name"><?= $sold['ProductName'] ?></a></h4>
                                                <div class="price ">
                                                    <ins><span class="price-amount"><span class="currencySymbol">£</span><?= number_format($dc['Price'])?></span></ins>
                                                    <!-- <del><span class="price-amount"><span class="currencySymbol">£</span>95.00</span></del> -->
                                                </div>
            ...
            <ul class="biolife-carousel nav-center-bold nav-none-on-mobile" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":4, "responsive":[{"breakpoint":1200, "settings":{ "slidesToShow": 4}},{"breakpoint":992, "settings":{ "slidesToShow": 3}},{"breakpoint":768, "settings":{ "slidesToShow": 2, "slidesMargin":10}},{"breakpoint":450, "settings":{ "slidesToShow": 1, "slidesMargin":10}}]}'>
                <li>
                    <div class="biolife-brd-container">
                        <a href="#" class="link">
                            <figure><img src="public/frontend/assets/images/home-03/brd-01.jpg" width="214" height="163" alt=""></figure>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="biolife-brd-container">
                        <a href="#" class="link">
                            <figure><img src="public/frontend/assets/images/home-03/brd-02.jpg" width="214" height="163" alt=""></figure>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="biolife-brd-container">
                        <a href="#" class="link">
                            <figure><img src="public/frontend/assets/images/home-03/brd-03.jpg" width="153" height="163" alt=""></figure>
                        </a>
                    </div>
                </li>
                <li>
                    <div class="biolife-brd-container">
                        <a href="#" class="link">
                            <figure><img src="public/frontend/assets/images/home-03/brd-04.jpg" width="224" height="163" alt=""></figure>
                        </a>
                    </div>
                </li>
                <li>
    ...
    <div class="blog-posts sm-margin-top-93px sm-padding-top-72px xs-padding-bottom-50px">
        <div class="container">
            <div class="biolife-title-box">
                ...
                <h3 class="main-title">Bài viết</h3>
            </div>
                ...
                <?php foreach ($list_blog as $key => $blog) : ?>
                    <li>
                        <div class="post-item effect-01 style-bottom-info layout-02 ">
                            <div class="thumbnail">
                                <a href="#" class="link-to-post"><img src="<?=BASE_PATH?>public/frontend/assets/images/products/<?=$blog['Image1']?>" width="370" height="270" alt=""></a>
                                <!-- <div class="post-date">
                            ...
                            <div class="post-content">
                                <h4 class="post-name"><a href="#" class="linktopost"><?=$blog['Topic']?></a></h4>
                                <!-- <div class="post-meta">
                                ...
                                <div class="group-buttons">
                                    <a href="<?=BASE_PATH?>blog_detail/<?= $blog['Slug'] ?>" class="btn readmore">Tiếp tục đọc</a>
                                </div>
                            </div>
                        </div>
                    </li>
