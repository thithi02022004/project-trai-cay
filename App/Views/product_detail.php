                ...
                <!-- summary info -->
                    <div class="sumary-product single-layout">
                        <div class="media">
                            ...
                            <?php foreach ($product_img as $key => $img) :?>
                                <li><img src="<?=BASE_PATH?>public/frontend/assets/images/products/<?=$img['Image']?>" alt="" width="500" height="500"></li>
                                <?php endforeach ?>
                            </ul>
                            <ul class="biolife-carousel slider-nav" data-slick='{"arrows":false,"dots":false,"centerMode":false,"focusOnSelect":true,"slidesMargin":10,"slidesToShow":4,"slidesToScroll":1,"asNavFor":".slider-for"}'>
                            <?php foreach ($product_img as $key => $img) :?>
                                <li><img src="<?=BASE_PATH?>public/frontend/assets/images/products/<?=$img['Image']?>" alt="" width="88" height="88"></li>
                                <?php endforeach ?>
                            </ul>
                        </div>
                    <div class="product-attribute">
                        <h3 class="title"><?=$product_detail['ProductName']?></h3>
                        <div class="rating">
                        ...
                        <span class="sku"><?=$product_detail['Description']?></span>
                        <!-- <p class="excerpt"><?=$product_detail['material']?></p> -->
                        <div class="price">
                            <ins><span class="price-amount"><span class="currencySymbol">£</span><?=number_format($product_detail['Price'])?></span></ins>
                        </div>
                    ...
                    <form action="<?=BASE_PATH?>add_cart&id=<?=$product_detail['ProductID']?>" method="POST">
                        <div class="action-form">
                            ...
                            <div class="buttons">
                                <!-- <a href="<?=BASE_PATH?>add_cart&id=<?=$product_detail['ProductID']?>" class="btn add-to-cart-btn">Thêm vào giỏ hàng</a> -->
                                ...
                                <div class="info">
                                    ...
                                    <div class="slide-down-box">
                                        ...
                                        <div class="buttons">
                                            ...
                                            <a href="<?=BASE_PATH?>product_detail/<?=$pro['Slug']?>" class="btn add-to-cart-btn"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Thêm vào giỏ</a>
                ...
                <div class="product-tabs single-layout biolife-tab-contain">
                    ...
                    <div class="tab-content">
                        <div id="tab_1st" class="tab-contain desc-tab active">
                            <p class="desc"><?=$product_detail['Description']?></p>
